...
class PurchaseRequestLine(models.Model):
    ...
    name = fields.Text('Description', track_visibility='onchange')
...
#     def productonhandset(self):
#         print("ppppppp pppppp pppppp",self.product_id.qty_available)
#         self.product_onhand=self.product_id.qty_available
    
    
    product_onhand = fields.Float(related='product_id.qty_available',
                                  string="Qty on Hand",readonly=True)
