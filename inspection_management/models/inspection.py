...
class Inspection(models.Model):
    ...
    product_id = fields.Many2one('product.product', 'Product', required=True, domain="[('is_rental', '=', True)]") 
    lot_id = fields.Many2one('stock.production.lot', 'Lot', domain="[('product_id', '=', product_id)]", context="{'default_product_id': product_id}", required=True)
